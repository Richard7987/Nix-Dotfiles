...

{
  ...
  # `doas tailscale set --exit-node=mullvad-exit` que hacías en FreeBSD, y no
  # depende del bug del driver wifi que tenías ahí (ver memoria
  # freebsd_wifi_boot_stall) — en esta máquina no debería repetirse.
